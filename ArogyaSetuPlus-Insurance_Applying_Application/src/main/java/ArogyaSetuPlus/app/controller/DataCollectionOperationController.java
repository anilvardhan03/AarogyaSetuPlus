...
public class DataCollectionOperationController {
	...
	try {
	    ...
	    return new ResponseEntity<List<PlanDetailsOutputs>>(planDetails, HttpStatus.FOUND);
	} catch (Exception e) {
	...
	try {
	    ...
	    return new ResponseEntity<PlanDetailsOutputs>(planDetails, HttpStatus.FOUND);
	} catch (Exception e) {
	    return new ResponseEntity<String>(e.getMessage(), HttpStatus.NOT_FOUND);
	}
    }
